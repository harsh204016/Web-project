  ...
  function submitForm()
  {
  	...
  	const pstate = document.getElementById('state').value;
...
const StopDate7 = document.getElementById('stopDate7').value;
...
const candidateVillage = document.getElementById('candidateVillage').value; 
const candidatepostalcode = document.getElementById('candidatepostalcode').value; 
const candidatestate = document.getElementById('candidatestate').value; 
...
if (candidateContact === undefined || candidateContact == null || candidateContact.length <= 0 || candidateEmail === undefined || candidateEmail == null || candidateEmail.length <= 0 || contactDate === undefined || contactDate == null || contactDate.length <= 0 || candidatestate === undefined || candidatestate === null|| candidatestate.length <=0 || candidateName === undefined || candidateName == null || candidateName.length <= 0 || candidateAddress === undefined || candidateAddress == null || candidateAddress.length <= 0 || candidateVillage === undefined || candidateVillage == null || candidateVillage.length <= 0 || candidatepostalcode === undefined || candidatepostalcode == null || candidatepostalcode.length <= 0 || pname === undefined || pname == null || pname.length <= 0 || prnNum === undefined || prnNum == null || prnNum.length <= 0 || placeofbirth === undefined || placeofbirth == null || placeofbirth.length <= 0 || ipdNum === undefined || ipdNum == null || ipdNum.length <= 0 || pAddress === undefined || pAddress == null || pAddress.length <= 0 || post === undefined || post == null || post.length <= 0 || village === undefined || village == null || village.length <= 0 || sex === undefined || sex == null || sex.length <= 0 || pAge === undefined || pAge == null || pAge.length <= 0 || pstate === undefined || pstate == null || pstate.length <= 0) {
...
db.collection("Formdata").add({
    ...
    batchNumber7: batch7,
    doseDetails7: dose7,
    AdminRoute7:  AdminRoute7,
    startDate7: StartDate7,
    stopDate7: StopDate7,
    reasonOfUse7: reason7,
    unwantedOccurrence1: occurence7,
    ...
    filerVillage: candidateVillage,
    FilerPostalCode: candidatepostalcode,
    FilerState: candidatestate,
